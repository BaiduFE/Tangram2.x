 ...
 * @function
 * @name baidu.query().css()
 * @grammar baidu.query(args).css(key)
 ...
 * @function
 * @name baidu.query().css()
 * @grammar baidu.query(args).css(key, value)
 * @param {String} key 一个css的属性名称.
 ...
 * @function
 * @name baidu.query().css()
 * @grammar baidu.query(args).css(map)
 ...
 * @function
 * @name baidu.query().css()
 * @grammar baidu.query(args).css(key, fn)
 * @param {String} key 一个css的属性名称.
