 ...
 * @function 
 * @name baidu.query().prop()
 * @grammar baidu.query(args).prop(Property)
 ...
 * @function 
 * @name baidu.query().prop()
 * @grammar baidu.query(args).prop(property,value)
 ...
 * @function 
 * @name baidu.query().prop()
 * @grammar baidu.query(args).prop(object)
 ...
 * @function 
 * @name baidu.query().prop()
 * @grammar baidu.query(args).prop(Property,fn)
 * @param {String} Property 要设置值的属性名.
