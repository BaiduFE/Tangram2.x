...
baidu.string.format = baidu.string.format || function(opts) {
    var source, data, toString = Object.prototype.toString;

    if (baidu.isFunction(this.valueOf())) {

        return baidu.string(arguments[0]).format(Array.prototype.slice.call(arguments, 1)[0]);
    }
