...
baidu.form.Validator = baidu.lang.createClass(function(form, fieldRule, options){
    ...
    baidu.object.each(me._fieldRule, function(value, key){
        baidu.each(baidu.lang.isString(value.eventName) ? value.eventName.split(',')
            : eventNameList,
            function(index, item){
                addEvent(item, key);
            });
 ...
 */
{
    ...
    validate: function(callback){
        var me = this,
            ...
            resultList = [],
            count = 0;
        baidu.each(keyList, function(index, item){
