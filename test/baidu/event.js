...
test('test baidu.event properties', function(){
    ...
    ua.importsrc('baidu.query.on', function(){
        ...
        baidu.query(c.get()).on('keyup', { tangId: 'Tangram' }, function(event){
        ...
        //
        baidu.query(c.get()).on('keyup', function( event ){
        ...
        baidu.query(c.get()).on('mouseup', function(event){
...
test('event preventDefault', function(){
    ...
    baidu.query(a).on('click', function(event){
...
test('event stopPropagation', function(){
    ...
    baidu.query(span).on('click', function(event){
