...
test("after TangramDom", function(){
	...
	baidu.query("div.B").after( baidu.query("div.A") );
...
test("after HTMLString", function(){
	div.innerHTML = "<div class='A'>A</div><div class='A'>A</div><div class='B'>B</div><div class='B'>B</div>";
	baidu.query("div.B").after( "<div>C</div>" );
...
test("after HTMLString", function(){
	div.innerHTML = "<div class='A'>A</div><div class='A'>A</div><div class='B'>B</div><div class='B'>B</div>";
	baidu.query("div.B").after( "<div>C</div><div>D</div>" );
...
test("after Function", function(){
	...
	baidu.query("div.B", div).after(function(index, html){
	    if(index == 0){
	        return a[0];
	    }else if(index == 1){
