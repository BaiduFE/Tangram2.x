...
test("appendTo selector", function(){
	...
	baidu.query("div.A").appendTo("div.B");
...
test("appendTo HTMLElement", function(){
    div.innerHTML = "<div class='A'>A</div><div class='A'>A</div><div class='B'>B</div><div class='B'>B</div>";
    baidu.query("div.A").appendTo( baidu.query("div.B")[0] );
...
test("appendTo HTML", function(){
    div.innerHTML = "<div class='A'>A</div><div class='A'>A</div><div class='B'>B</div><div class='B'>B</div>";
    var a = baidu.query("div.A").appendTo( "<div class='C'>C</div><div class='D'>D</div>" );
...
test("appendTo TangramDom", function(){
    div.innerHTML = "<div class='A'>A</div><div class='A'>A</div><div class='B'>B</div><div class='B'>B</div>";
    baidu.query("div.A").appendTo( baidu.query("div.B") );
