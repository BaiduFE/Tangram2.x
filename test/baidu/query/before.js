...
test("before TangramDom", function(){
	...
	baidu.query("div.B").before( baidu.query("div.A") );
...
test("before HTMLString", function(){
	div.innerHTML = "<div class='A'>A</div><div class='A'>A</div><div class='B'>B</div><div class='B'>B</div>";
	baidu.query("div.B").before( "<div>C</div>" );
...
test("before HTMLString", function(){
	div.innerHTML = "<div class='A'>A</div><div class='A'>A</div><div class='B'>B</div><div class='B'>B</div>";
	baidu.query("div.B").before( "<div>C</div><div>D</div>" );
...
test("before Function", function(){
	div.innerHTML = "<div class='A'>A</div><div class='A'>A</div><div class='B'>B</div><div class='B'>B</div>";
	var a = baidu.query("div.A", div);
	baidu.query("div.B", div).before(function(index, html){
	    if(index == 0){
	        return a[0];
	    }else if(index == 1){
