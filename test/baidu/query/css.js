...
var css = function( name, value ){ return baidu.query( div ).css( name, value ); };
...
test('baidu.query(div).css(name)', function(){
    stop();
    ua.importsrc('baidu.query.styleFixer', function(){
        ...
        start();
    }, 'baidu.query.styleFixer', 'baidu.query.css');
});

test("baidu.query(div).css(name,value)", function(){
