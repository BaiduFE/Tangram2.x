...
test("获取自定义属性", function () {
    ...
    equal( baidu.query('#test-data1').data("rayi").dashu,"jihu", "取得data-开头的自定义Object" );    

    var div2 = document.createElement('div');
    div2.id = 'test-data2';
    div2.setAttribute('data-rayi','jiyou');
    document.body.appendChild(div2);
    equal( baidu.query('#test-data2').data("rayi"), "jiyou", "取得data-开头的自定义属性" );    
});
...
test('当传入值是0的时候', function(){
    ...
    baidu.query(a).data('tangram-key', 0);
    ok(baidu.query(a).data('tangram-key') === 0, 'get value is 0');
...
test('Object类型', function(){
    ...
    baidu.query(div).data({a:123,b:234,c:345});
