...
test('test normal delegate', function(){
    ...
    var c = new Span(),
        span = c.get();
    baidu.query(span).delegate('div', 'click', function(){
...
test('test data delegate', function(){
    ...
    var c = new Span(),
        span = c.get();
    baidu.query(span).delegate('div', 'click', {tangId: 'Tangram'}, function(evt){
...
test('test', function(){
    ...
    baidu.query(span).delegate('a', 'click', function(){
        ok(true, 'delegate');
    });
...
test('test', function(){
    ...
    baidu.query(div).delegate('div', 'click', function(){
        ok(true, 'delegate');
    });
...
test('handler', function(){
    ...
    baidu.query(div).delegate('span', 'click', function(evt){
        if( index < 2 ){
