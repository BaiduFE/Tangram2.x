...
test('参数不是string',function(){
	var test = 1;
	expect(2);
	equal(baidu.query.g(test),null,"get 1 from 1");
...
test('id或element',function(){
	...
	equal(baidu.query.g('id_div'),div,"get div by id");//id
	equal(baidu.query.g(div),div,"get div by element");//element
...
test('特殊参数',function(){
	...
	equal(baidu.query.g(document),document,"get document");//get document
	equal(baidu.query.g(document.body),document.body,"get body");//get body
...
test('baidu.query.g(baidu.query.g("***"))',function(){
	expect(3);
	equal(baidu.g(null),null,"get null para");
