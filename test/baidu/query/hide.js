module("baidu.query.hide",{});

test('prepareTest',function(){
	expect(1);
	stop();
	ua.importsrc("baidu.query.append,baidu.query.show,baidu.query.each,baidu.query.trigger,baidu.query.find,baidu.query.css,baidu.query.appendTo,baidu.query.removeAttr,baidu.query.insertAfter,baidu.query.html,baidu.query.eq,baidu.query.remove,baidu.query.contents", function(){
		start();
		prepareTest();
		ok(true,'ok');
	}, "baidu.query.contents", "baidu.query.hide");
});
