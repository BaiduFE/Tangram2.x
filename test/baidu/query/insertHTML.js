module('baidu.query.insertHTML测试')
//加载快捷方式
/*
test('prepareTest',function(){
	...
	ua.importsrc("baidu.short", function(){
		start();
		ok(true,'ok');
	}, "baidu.trim", "baidu.query.insertHTML");
...
test('在元素的开始标签后插入html', function() {
	...
	oP.innerHTML = 'p2_ih';
	baidu.query(oP).insertHTML( "afterBegin", "文本信息");
...
test('在元素的结束标签后插入html', function() {
	...
	var op1 = baidu.query(oP).insertHTML( "afterEnd",
...
test('FF下的特殊情况',function(){
	...
	baidu.query(td).insertHTML( 'beforeEnd', '<div id="test2"><div><table id="table2"><tr><td></td></tr></table></div></div>');
	baidu.query(td).insertHTML( 'afterBegin', '<div id="test1"><div><table id="table1"><tr><td></td></tr></table></div></div>');
