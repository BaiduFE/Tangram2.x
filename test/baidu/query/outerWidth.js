module('baidu.query.outerWidth');

test("baidu.query(el).outerWidth()", function(){
	testGet( "div" );
	testGet( "span" );//如何改
	testGet( "body" );
	testGet( "input" );
...
function testGet( tag ){
	var el = create( tag );
	equal( baidu.query( el ).outerWidth(), el.offsetWidth, "check " + tag + " outerWidth()" );
	equal( baidu.query( el ).outerWidth( true ), el.offsetWidth + style(el, 'marginLeft') + style(el, 'marginRight'), "check " + tag + " outerWidth( true )" );
//    equal( baidu.query( el ).outerWidth(), 100, "check " + tag + " outerWidth()" );
//    equal( baidu.query( el ).outerWidth( true ), 140, "check " + tag + " outerWidth( true )" );
