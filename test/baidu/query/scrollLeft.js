module('baidu.query.scrollLeft');

test("baidu.query().scrollLeft()", function(){
...
test("baidu.query().scrollLeft(value)", function(){
	var div, textarea, body, iframe;
...
test("baidu.query().scrollLeft( NaN )", function(){
	var div, textarea, body, iframe;
...
test("baidu.query().scrollLeft( -n )", function(){
	var div, textarea, body, iframe;
...
test("baidu.query().scrollLeft( n.n )", function(){
	var div, textarea, body, iframe;
