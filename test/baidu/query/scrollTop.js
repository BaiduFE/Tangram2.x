module('baidu.query.scrollTop');

test("baidu.query().scrollTop()", function(){
...
test("baidu.query().scrollTop(value)", function(){
	var div, textarea, body, iframe;
	div = create( "div" );
...
test("baidu.query().scrollTop( NaN )", function(){
	var div, textarea, body, iframe;
...
test("baidu.query().scrollTop( -n )", function(){
	var div, textarea, body, iframe;
...
test("baidu.query().scrollTop( n.n )", function(){
	var div, textarea, body, iframe;
