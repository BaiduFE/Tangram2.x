module("baidu.query.show",{});

test('prepareTest',function(){
	expect(1);
	stop();
	ua.importsrc("baidu.query.css,baidu.query.append,baidu.query.hide,baidu.query.each,baidu.query.trigger,baidu.query.find,baidu.query.css,baidu.query.appendTo,baidu.query.removeAttr,baidu.query.insertAfter,baidu.query.html,baidu.query.eq,baidu.query.remove,baidu.query.contents", function(){
		start();
		prepareTest();
		ok(true,'ok');
	}, "baidu.query.contents", "baidu.query.show");
});
...
test('prepareTest',function(){
	...
	ua.importsrc("baidu.short", function(){
		start();
		ok(true,'ok');
	}, "baidu.trim", "baidu.query.show");
});
*/
test("show()", function() {
	//expect(26);
	var hiddendiv = baidu.query(".hidden");
	hiddendiv.hide().show();
