...
test('单个节点的兄弟', function () {
	useTangramDom(html, function ($dom, wrapper) {
		var target = baidu.query('.item-a').siblings();
...
test('多个节点的兄弟（不重复）', function () {
	useTangramDom(html, function ($dom, wrapper) {
		var target = baidu.query('.item-ii, .item-a').siblings();
...
test('多个节点的兄弟（有重复）', function () {
	useTangramDom(html, function ($dom, wrapper) {
		var target = baidu.query('.item-a, .item-c').siblings();
