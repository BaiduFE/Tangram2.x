...
test('sizzle接口：prepareTest',function(){
    expect(1);
    stop();
    ua.importsrc('baidu.query.appendTo,baidu.query.removeAttr,baidu.query.remove,baidu.query.insertAfter,baidu.query.prop,baidu.query.contents,baidu.query.text,baidu.query.css,baidu.query.height,baidu.query.width,baidu.query.html', function(){
        start();
        prepareTest();
        ok(true,'ok');
